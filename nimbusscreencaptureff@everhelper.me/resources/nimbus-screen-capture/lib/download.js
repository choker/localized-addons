...
if (Downloads.getList) {  // use Downloads.jsm
  ...
  var ioService = Cc["@mozilla.org/network/io-service;1"].getService(Ci.nsIIOService),
      dm = Cc["@mozilla.org/download-manager;1"].getService(Ci.nsIDownloadManager);
  get = function (callback, pointer) {
    var dl,
    ...
    return function (url, file, aPrivacyContext, aIsPrivate, callback2, pointer2) {
      ...
      var urlURI = ioService.newURI(url, null, null),
          fileURI = ioService.newFileURI(localFile);
      ...
      persist.saveURI(dl.source, null, null, null, null, localFile, aPrivacyContext);
