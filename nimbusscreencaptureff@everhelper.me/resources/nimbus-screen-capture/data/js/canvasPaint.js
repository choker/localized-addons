...
//                this.drawNumber();
            ...
            this.move = function(dx, dy) {
                ...
                if(this.marker == 2 || this.marker == 4) {
                    this.xb1 = this.xb1Last + dx;
                    if ((this.xb2 - this.xb1) < 34) {
                        this.xb1 = this.xb2 - 34;
                    }
                }

                if(this.marker == 2 || this.marker == 3) {
                    this.yb1 = this.yb1Last + dy;
                    if ((this.yb2 - this.yb1) < 34){
                        this.yb1 = this.yb2 - 34;
                    }
                }
...
//                    }
        ...
        var drawStart = function(event) {
            ...
            if (state.shadow.enable) {
                ...
                canvas.current.context.shadowBlur = 0;
            }
            ...
            if (state.drawing) {
                ...
                switch (state.tool) {
                    ...
                    case TOOLS.LINE_CURVE:
                        ...
                        if(state.shadow.enable || state.tool===TOOLS.ARROW_CURVE) {
                            var l = points.length;
...
//        };
        ...
        var blurImage = function(startX, startY, endX, endY) {
            ...
            if (width > 4 && height > 4) {
                ...
                imageData = blurData(imageData, 3);
...
//            }
        ...
        this.zoom = function(k) {
            ...
            this.css('-moz-transform', 'scale(' + k + ')');
            kzoom = k;
        ...
        this.setShadow = function(s) {
            state.shadow = s;
            localStorage.shadow = JSON.stringify(s);
        };
